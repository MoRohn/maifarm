...
interface SafeErrorPageProps {
  error?: Error;
  resetError?: () => void;
}

// This is a router-agnostic version of ErrorPage that doesn't use useNavigate
const SafeErrorPage: React.FC<SafeErrorPageProps> = ({ error, resetError }) => {
