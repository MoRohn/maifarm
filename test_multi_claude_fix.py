#!/usr/bin/env python3
"""
Test script to diagnose multi_claude.py issues
"""
...
def test_multi_claude_import():
    """Test if multi_claude.py can be imported"""
    print("\n=== Testing multi_claude.py Import ===")
    try:
        # Add current directory to path
        sys.path.insert(0, os.getcwd())
        import multi_claude
        print("✓ multi_claude.py imported successfully")
        return True
    except Exception as e:
        print(f"✗ Failed to import multi_claude.py: {e}")
        return False

def diagnose_hanging_issue():
    """Diagnose why multi_claude.py might be hanging"""
...
def main():
    print("=" * 60)
    print("Multi-Claude Diagnostic Test")
    print("=" * 60)
    ...
    # Test importing multi_claude
    test_multi_claude_import()
