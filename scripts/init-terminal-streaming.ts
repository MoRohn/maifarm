 ...
 *
 * Usage: npx tsx scripts/init-terminal-streaming.ts <farmId> <sessionName>
 */
...
if (!farmId || !sessionName) {
  console.error('Usage: npx tsx scripts/init-terminal-streaming.ts <farmId> <sessionName>');
  console.error('');
  console.error('Example: npx tsx scripts/init-terminal-streaming.ts b5b0d117-24a3-42b6-89d2-f8728d3e24ae farm-b5b0d117');
  process.exit(1);
}
