...
test_farm_mode() {
    ...
    heartbeat_file="/Users/rohnspringfield/maifarm/var/maibarn/terminals/${farm_id}/orchestrator.heartbeat"
    ...
    # Check log files
    log_dir="/Users/rohnspringfield/maifarm/var/maibarn/terminals/${farm_id}"
    if [ -d "$log_dir" ]; then
