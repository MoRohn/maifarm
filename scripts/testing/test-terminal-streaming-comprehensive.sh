...
WORKSPACE_DIR="${MAIFARM_ROOT}/var/maibarn/workspaces"
COORDINATION_DIR="${MAIFARM_ROOT}/maibarn/coordination"
TERMINALS_DIR="${MAIFARM_ROOT}/var/maibarn/terminals/${FARM_ID}"
NUM_AGENTS=3
