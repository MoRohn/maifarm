                ...
                <div className="mt-4">
                  ...
                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                    <div
                      ...
                      style={{
                        // FIX: Prevent division by zero when nodeExecutions is empty
                        width: `${execution.nodeExecutions.length > 0
                          ? (execution.nodeExecutions.filter(s => s.status === 'completed').length / execution.nodeExecutions.length) * 100
                          : 0}%`
                      }}
                    />
                  </div>
