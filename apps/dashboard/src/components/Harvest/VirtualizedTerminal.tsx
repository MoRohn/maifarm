...
const LineRenderer = React.memo<{
  ...
  // Parse ANSI codes safely with XSS sanitization
  const parsedContent = useMemo(() => {
    try {
      ...
      const parsed = AnsiParser.parseToHtml(truncated);

      // FIX: Sanitize to prevent XSS attacks
      return DOMPurify.sanitize(parsed, {
        ALLOWED_TAGS: ['span', 'b', 'i', 'strong', 'em', 'code', 'br'],
