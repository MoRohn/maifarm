...
CREATE INDEX IF NOT EXISTS idx_tmux_sessions_farm_id ON tmux_sessions(farm_id);
CREATE INDEX IF NOT EXISTS idx_tmux_sessions_status ON tmux_sessions(status);
CREATE INDEX IF NOT EXISTS idx_tmux_sessions_heartbeat ON tmux_sessions(last_heartbeat);

-- Lifecycle events indexes
CREATE INDEX IF NOT EXISTS idx_lifecycle_events_farm_id ON farm_lifecycle_events(farm_id);
CREATE INDEX IF NOT EXISTS idx_lifecycle_events_type ON farm_lifecycle_events(event_type);
CREATE INDEX IF NOT EXISTS idx_lifecycle_events_created ON farm_lifecycle_events(created_at DESC);
