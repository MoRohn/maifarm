...
/**
 * Get SIMPLE agent name by index - matches UnifiedFarmLaunchOrchestrator
 * This ensures naming consistency across the entire system
 */
...
export default {
  ...
  getAgentName,
  getSimpleAgentName  // Add the new simple name method
};